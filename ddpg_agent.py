...
class Agent():
    ...
    def __init__(self, state_size, action_size, random_seed, sigma=0.05):
        ...
        # ADDED TO HAVE MATCHING WEIGHTS AT START (PROPOSED BY CLASSMATE Gregorio Mezquita)
    ...
    def step(self, state, action, reward, next_state, done):
        ...
        for s, t, r, n, d in zip(state, action, reward, next_state, done):
            self.memory.add(s, t, r, n, d)
